...
export default {
  data () {
    ...
    return {
      members: [
        { name: 'test', position: '代表', img: member1, twitter, slack },
        { name: 'マイケル', position: 'エンジニア', img: member2 },
        { name: 'ルイージ', position: 'エンジニア', img: member3 }
      ],
      infomations: [
        { icon: 'mdi-domain', text: 'test株式会社' },
        { icon: 'mdi-link-variant', link: companyUrl },
        { icon: 'mdi-flag', text: '2020年7月に設立' },
        { icon: 'mdi-account-multiple', text: '3人のメンバー' },
        { icon: 'mdi-map-marker', text: '東京都港区' },
